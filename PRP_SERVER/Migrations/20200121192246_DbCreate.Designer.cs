...
namespace PRP_SERVER.Migrations
{
    ...
    [Migration("20200121192246_DbCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRP_SERVER.Models.Company", b =>
                {
                    b.HasOne("PRP_SERVER.Models.Company", "Branch")
                        .WithMany()
            ...
            modelBuilder.Entity("PRP_SERVER.Models.Contact", b =>
                {
                    b.HasOne("PRP_SERVER.Models.Company", "Company")
                        .WithOne("Contact")
                        .HasForeignKey("PRP_SERVER.Models.Contact", "CompanyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("PRP_SERVER.Models.Note", b =>
                {
                    b.HasOne("PRP_SERVER.Models.Company", "Company")
                        .WithOne("Note")
                        .HasForeignKey("PRP_SERVER.Models.Note", "CompanyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
